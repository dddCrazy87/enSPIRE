    ...
    //                    <#code#>
                ...
                case .gallery:
                    GalleryView()
                        ...
                        .toolbarColorScheme(.light, for: .bottomBar)
                case .profile:
                    UserProfileView(userInfo: userInfo, tabIndex: 0, mindmapProj: mindMapProj, piecesProj: piecesPjoj)
                        .toolbarBackground(.visible, for: .bottomBar)
                        .toolbarColorScheme(.light, for: .bottomBar)
                default:
                    Text("error")
